...
function SchemaBlock() {
  return (
    <pre className="font-mono text-[10px] md:text-xs leading-[2] m-0 overflow-x-auto">
      ...
      <Line>  <span className={k}>alcance:</span> <span className={t}>texto</span>              <span className={c}># Qué se acuerda entregar</span></Line>
      <Line>  <span className={k}>precio:</span> <span className={t}>número</span>              <span className={c}># Precio total acordado</span></Line>
      <Line>  <span className={k}>esquema_pagos:</span> <span className={t}>texto</span>         <span className={c}># prepago | por_sesión | mensual</span></Line>
      <Line>  <span className={k}>currency:</span> <span className={t}>texto</span>             <span className={c}># ISO 4217</span></Line>
      <Line>&nbsp;</Line>
      <Line>  <span className={a}>servicios[]:</span>                       <span className={c}># Cada servicio atómico — 8 dimensiones</span></Line>
      <Line>&nbsp;</Line>
      <Line>    <span className={a}>servicio:</span></Line>
      <Line>      <span className={k}>id:</span> <span className={t}>texto</span>                 <span className={c}># Identificador único</span></Line>
      <Line>      <span className={k}>orden_de_servicio_id:</span> <span className={t}>texto</span> <span className={c}># Referencia a la Orden padre</span></Line>
      ...
      <Line>&nbsp;</Line>
      <Line>      <span className={a}>resolución:</span></Line>
