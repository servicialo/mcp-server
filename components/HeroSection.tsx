...
export async function HeroSection() {
  ...
  return (
    <section className="mb-14 md:mb-20">
      ...
      <p className="text-[14px] md:text-[15px] text-text-muted leading-[1.7] max-w-[540px] mb-3">
      ...
      <p className="text-[15px] md:text-lg text-text-body leading-[1.7] max-w-[600px]">
        Cada servicio entregado deja una Prueba de Servicio: el vínculo verificable entre lo entregado y lo liquidado.
      </p>
