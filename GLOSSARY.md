...
|-------|--------|------------|----------------|--------------|
| TC | Transaccion Coordinada | Unidad minima de coordinacion resuelta cuando una entrega y un pago especifico quedan verificados | Operacion por atencion, sesion o prestacion individual | Comision por transaccion resuelta |
...
|------|---------------|-------------|
| TC-native | `sessionId` | Sesion individual |
...
TC  x fee_variable = escala con volumen de transacciones
```
